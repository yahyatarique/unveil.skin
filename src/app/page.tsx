  ...
  return (
    <Box minH="100vh" className="bg-gradient-to-br from-zinc-50 via-white to-zinc-100 dark:from-black dark:via-zinc-950 dark:to-zinc-900">
      ...
      <Box as="main" maxW="7xl" mx="auto" px={6} py={{ base: 16, md: 24 }}>
        {/* Brand intro */}
        <Stack mb={16} align="center" textAlign="center">
          <Heading
            as="h2"
        ...
        {/* Coming Soon Footer */}
        <Box borderTop="1px" className="border-zinc-200 dark:border-zinc-800" pt={12}>
          <VStack gap={4} align="center" textAlign="center">
            ...
            <Text maxW="md" fontSize="sm" className="text-zinc-500">
